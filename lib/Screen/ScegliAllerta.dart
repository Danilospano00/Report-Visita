...
_aggiungiSoglieAllerta() async {
  ...
  String scegliAllerta1 = formKeyScegliAllerta
      .currentState?.fields['scegliAllerta1']!.value ??
      "7";

  String scegliAllerta2 = formKeyScegliAllerta
      .currentState?.fields['scegliAllerta2']!.value ??
      "14";

  String scegliAllerta3 = formKeyScegliAllerta
      .currentState?.fields['scegliAllerta3']!.value ??
      "21";
