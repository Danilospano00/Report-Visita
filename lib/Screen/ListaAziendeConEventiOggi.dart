...
class ListaAziendeConEventiOggiState extends State<ListaAziendeConEventiOggi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).translate('titoloListaAziendeConEventiOggi')),
        backgroundColor: Colors.transparent,
        shadowColor: Colors.transparent,
        titleTextStyle: TextStyle(color: Colors.grey[700], fontWeight: FontWeight.w700, fontSize: 20.sp),
        iconTheme: IconThemeData(color: Colors.grey[700]),
      ),
      body: widget.listaEventiDiOggi.isEmpty
          ? Center(
              child: Text(
                AppLocalizations.of(context).translate('nessunEventoOggi'),
                  ...
                  Padding(
                    ...
                    child: AutoSizeText(
                      AppLocalizations.of(context)
                          .translate('eventiInProgrammaOggi'),
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => AziendaDettaglio(
                                      azienda: widget.listaEventiDiOggi[index]
                                          .azienda.target!)));
                        },
                        child: Column(
                          children: [
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              widget.listaEventiDiOggi[index]
                                                  .azienda.target!.nome!,
                                              style: TextStyle(
                                      ...
                                      widget.listaEventiDiOggi[index].azienda
                                                  .target!.indirizzo !=
                                              null
                                          ? Padding(
                                              padding:
